@extends('voyager::master')
 ...
 @if(isset($id))
        ...
        @section('page_title',Voyager::setting('admin_title') . " - 编辑新闻")

@else

    @section('page_title',Voyager::setting('admin_title') . " - 新增新闻")
...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-paw"></i> @if(isset($id)) 编辑新闻 @else 新增新闻 @endif
    </h1>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body">
                     ...
                     <form role="form" class="form-edit-add"  @if(isset($id)) action="{{url('admin/news/'.$id)}}" @else action="{{url('admin/news')}}" @endif   method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="请输入专题名称" value="@if(isset($data->title)){{old('title', $data->title)}}@else{{old('title')}}@endif">
                             ...
                             <div class="form-group">
                                 <label class="col-md-2 control-label">新闻描述</label>
                                 <textarea placeholder="请输入新闻描述" id="dec" name="dec" class="form-control">@if(isset($data->dec)){{old('dec', $data->dec)}}@else{{old('dec')}}@endif</textarea>
                             </div>

                        <div class="form-group">

                            <div class="form-group">
                                <label  class="col-md-8 control-label" for="header_pic">新闻封面小图  &nbsp;&nbsp;&nbsp;  <code>提示：禁止上传带中文名称图片，最大限1M 图片像素：600 x 350</code></label>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">新闻排序</label>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">新闻状态</label>
                        ...
                        <div class="panel-footer">
                            <button type="submit" class="btn btn-primary save">
                                 ...
                                 @if(isset($id)) 编辑新闻 @else 新增新闻 @endif
