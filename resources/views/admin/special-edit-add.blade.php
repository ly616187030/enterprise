                    ...
                    <div class="panel-body">
                     ...
                     <form role="form" class="form-edit-add"  @if(isset($id)) action="{{url('admin/special/'.$id)}}" @else action="{{url('admin/special')}}" @endif   method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                             ...
                             <textarea placeholder="请输入专题描述" id="dec" name="dec" class="form-control">@if(isset($data->dec)){{old('dec', $data->dec)}}@else{{old('dec')}}@endif</textarea>
                        </div>

                        <div class="form-group">

                            <div class="form-group">
                                <label  class="col-md-8 control-label" for="header_pic">专题封面小图  &nbsp;&nbsp;&nbsp;  <code>提示：禁止上传带中文名称图片，最大限1M 图片像素：472 x 303</code></label>
