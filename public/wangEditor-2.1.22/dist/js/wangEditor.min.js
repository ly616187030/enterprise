...
!function (a) {
    ...
    return function (a, b) {
        ...
        c.fn._render = function () {
            ...
            f / 2 > d && (h = 0 - d), c.css({"margin-left": g + "px", "_": h + i + "px"})
        }, c.fn.show = function () {
            var a = this, b = a.menu;
            if (a.rendered || a._render(), !a.isShowing) {
                a.isShowing = !0;
        ...
        c.fn.render = function () {
            ...
            function a(a) {
                ...
                var b = (g.position().top, g.outerHeight(), a.height()), c = a.position().top,
                    d = parseInt(a.css("_"), 10), j = parseInt(a.css("padding-top"), 10),
        ...
        a.createMenu(function (c) {
            ...
            if (c(e)) {
                ...
                i.isShowCode = !1, i.clickEvent = function (a) {
                    ...
                    k.css({height: j, "_": h - j}), k.val(g.html()), k.on("change", function (a) {
                        d()
        ...
        a.createMenu(function (c) {
            ...
            if (c(d)) {
                var e, f, g, h = this, i = h.config.lang, j = new a.Menu({editor: h, id: d, title: i.table}),
                    ...
                    l = b('<table class="choose-table" style="margin-bottom:10px;_:5px;">'),
        ...
        a.createMenu(function (c) {
            ...
            if (c(d)) {
                ...
                var o = b("<div></div>"),
                    p = b('<a href="http://www.kancloud.cn/wangfupeng/wangeditor2/134973" target="_blank" style="display:inline-block;_:10px;margin-left:10px;color:#999;">如何复制视频链接？</a>'),
        ...
        a.baiduMapAk = "TVhjYjq1ICT2qqL5LdS8mwas", a.numberOfLocation = 0, a.createMenu(function (d) {
            ...
            if (d(f)) {
                ...
                var u = b('<div style="margin:10px 0;"></div>'),
                    ...
                    x = b('<label style="display:inline-block;_:10px;color:#666;"></label>'),
            ...
            if (d(g)) {
                ...
                l.clickEvent = function (a) {
                    ...
                    if (e && e.listLanguages) {
                        ...
                        o.css({"_": "9px", "margin-left": "5px"}), b.each(e.listLanguages(), function (a, b) {
        ...
        a.userAgent.indexOf("MSIE 8") > 0 || a.plugin(function () {
            ...
            function f() {
                ...
                s.on("mousedown", function (k) {
                    j && (c = k.pageX, d = k.pageY, e = parseFloat(s.css("margin-left"), 10), f = parseFloat(s.css("_"), 10), g = j.width(), i = j.height(), t.hide(), a.$document.on("mousemove._dragResizeImg", b), a.$document.on("mouseup._dragResizeImg", function (b) {
        ...
        a.plugin(function () {
            ...
            if (c !== !1 && "number" == typeof c) {
                var d = parseFloat(a.$body.css("_"), 10);
                isNaN(d) && (d = 0);
                ...
                a.$window.scroll(function () {
                    if (!b.isFullScreen) {
                        ...
                        0 === k && (k = h.offset().top, f = e.offset().top, g = e.outerHeight(), l = h.outerHeight()), m >= k && m + c + l + 30 < f + g ? (h.css({
                            position: "fixed",
                            top: c
                        }), h.width(n), a.$body.css({"_": d + l}), b._isMenufixed || (b._isMenufixed = !0)) : (h.css({
                            position: i,
                            top: j
                        }), h.css("width", "100%"), a.$body.css({"_": d}), b._isMenufixed && (b._isMenufixed = !1))
                    }
                })
            }
        })
